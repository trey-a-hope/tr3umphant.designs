    ...
    return Column(
      children: [
        SectionHeading(
          ...
          globalKey: widget.portfolioGlobalKey,
          title: 'Portfolio',
        ),
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: Text(
                          Globals.apps[0].description,
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontFamily: 'Electrolize',
                            fontSize: widget.screenSize.width / 40,
                            color: Colors.white,
                          ),
                        ),
                      ),
                      Row(
                        ...
                        children: [
                          InkWell(
                            onTap: () async {
                              if (!await launch(Globals.apps[0].iOSLink)) {
                          ...
                          InkWell(
                            onTap: () async {
                              if (!await launch(Globals.apps[0].androidLink)) {
                                throw 'Could not launch ';
                              }
                            },
                            child: CircleAvatar(
